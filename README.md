...
본 프로젝트는 **AWS 기반 MSA 구조**, **Docker 컨테이너**, **CI/CD 자동 배포**, **Blue-Green 배포 전략**을 적용하여 실제 서비스 운영 환경과 유사한 아키텍처를 목표로 설계되었습니다.
...
## 3️⃣ AI 회의 요약 생성
변환된 텍스트를 기반으로 **OpenAI API**를 이용해 회의 요약을 생성합니다.
